...
本目录包含了 `rust-common` 项目的 CircleCI 持续集成配置。
...
```bash
cargo llvm-cov --package qubit-common --lcov --output-path coverage.lcov
cargo llvm-cov --package qubit-common
```
...
**CircleCI 仪表板**：
```
https://app.circleci.com/pipelines/github/qubit-ltd/rust-common
```
...
```markdown
[![CircleCI](https://img.shields.io/circleci/build/github/qubit-ltd/rust-common/main?label=build&logo=circleci)](https://circleci.com/gh/qubit-ltd/rust-common)
```

效果预览：

![CircleCI Badge](https://img.shields.io/circleci/build/github/qubit-ltd/rust-common/main?label=build&logo=circleci)
...
```markdown
[![codecov](https://codecov.io/gh/qubit-ltd/rust-common/branch/main/graph/badge.svg)](https://codecov.io/gh/qubit-ltd/rust-common)
```
...
创建 `rust-common/.cargo-audit.toml`：
...
curl -X POST \
  ...
  https://circleci.com/api/v2/project/gh/qubit-ltd/rust-common/pipeline
```
...
- 🐛 Issue：[GitHub Issues](https://github.com/qubit-ltd/rust-common/issues)
- 💡 讨论：[GitHub Discussions](https://github.com/qubit-ltd/rust-common/discussions)
