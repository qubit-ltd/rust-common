...
本目录包含了 `common-rust` 项目的 CircleCI 持续集成配置。
...
**CircleCI 仪表板**：
```
https://app.circleci.com/pipelines/github/qubit-ltd/common-rust
```
...
```markdown
[![CircleCI](https://img.shields.io/circleci/build/github/qubit-ltd/common-rust/main?label=build&logo=circleci)](https://circleci.com/gh/qubit-ltd/common-rust)
```

效果预览：

![CircleCI Badge](https://img.shields.io/circleci/build/github/qubit-ltd/common-rust/main?label=build&logo=circleci)
...
```markdown
[![codecov](https://codecov.io/gh/qubit-ltd/common-rust/branch/main/graph/badge.svg)](https://codecov.io/gh/qubit-ltd/common-rust)
```
...
创建 `common-rust/.cargo-audit.toml`：
...
curl -X POST \
  ...
  https://circleci.com/api/v2/project/gh/qubit-ltd/common-rust/pipeline
```
...
- 🐛 Issue：[GitHub Issues](https://github.com/qubit-ltd/common-rust/issues)
- 💡 讨论：[GitHub Discussions](https://github.com/qubit-ltd/common-rust/discussions)
